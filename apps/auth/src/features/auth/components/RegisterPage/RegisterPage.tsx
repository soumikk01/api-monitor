          ...
          <main className={styles.main}>
            <div className={styles.card}>
              ...
              <div className={styles.oauthRow}>
                <button type="button" className={styles.oauthBtn} aria-label="Sign up with Google" onClick={() => alert('Google OAuth coming soon')}>
                ...
                <button type="button" className={styles.oauthBtn} aria-label="Sign up with GitHub" onClick={() => alert('GitHub OAuth coming soon')}>
